        ...
        <div className="about body-font" id="about">
          ...
          <div className="right-section">
            ...
            <p className="Descriptive-text">
              A web developer with a passion for clean design and functional
              code, I specialize in building responsive, user-focused websites
              that make a lasting impact. With a strong foundation in front-end
              and back-end technologies, I aim to deliver digital solutions that
              are not only visually appealing but also optimized for performance
              and user experience. Whether it's a simple landing page or a
              complex web application, every project is built with precision,
